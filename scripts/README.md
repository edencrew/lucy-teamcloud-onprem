...
## 2.3 `docker-compose.docker.yml`

Docker Compose 전용 override 파일입니다.
...
init-secrets 완료 대기
db healthcheck 대기
서비스별 조건부 depends_on 유지
```

이 파일은 Docker용 스크립트에서만 자동 포함됩니다. Podman은 이 파일을 사용하지 않습니다.

---

## 2.4 `docker-compose.podman.yml`
...
## 2.5 `scripts/export-compose-images.sh`
...
## 2.6 `scripts/load-compose-images.sh`
