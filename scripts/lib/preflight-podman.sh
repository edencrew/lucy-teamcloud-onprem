...
show_help() {
  cat <<'EOF'
preflight-onprem.sh (Podman runtime)
...
USAGE
  ONPREM_RUNTIME=podman ./scripts/preflight-onprem.sh [OPTIONS]
...
EXAMPLES
  Basic check:
    ONPREM_RUNTIME=podman ./scripts/preflight-onprem.sh

  Check and start services:
    ONPREM_RUNTIME=podman ./scripts/preflight-onprem.sh --compose-up

  Run from anywhere:
    PROJECT_ROOT=/opt/lucy-teamcloud-onprem ONPREM_RUNTIME=podman /opt/lucy-teamcloud-onprem/scripts/preflight-onprem.sh
